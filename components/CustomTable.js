	...
	return (
		<table className="border-collapse table-fixed w-full text-sm mb-3">
			...
			<tr className={'border-b'}>
				<CustomTableHeader colName={"Вправа"}/>
				<CustomTableHeader colName={"Підходи"}/>
				<CustomTableHeader colName={"Повторів"}/>
				<CustomTableHeader colName={"Вага"}/>
				<CustomTableHeader colName={"Відпочинок між підходами"}/>
			</tr>
			</thead>
