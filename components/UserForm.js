	...
	return (
		<form className="w-full my-10 mt-6 p-4 border border-gray-100 rounded-xl shadow-md" onSubmit={handleSubmit} autoComplete={"off"}>
			<div className="flex flex-wrap -mx-3 mb-2">
				<div className="w-full md:w-1/3 px-3 mb-6 md:mb-0" style={{display:'none'}}>
					<CustomSelect
						id={'model'}
						label={'AI Source'}
						values={AI_SOURCES}
			...
			<div className="flex flex-wrap -mx-3 mb-3">
				<div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
					<InputText label={"Ріст (см)"} id={"height"}/>
				</div>
				<div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
					<InputText label={"Вага (кг)"} id={"weight"}/>
				</div>
				<div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
					<InputText label={"Вік"} id={"age"}/>
				</div>
			</div>
			<div className="flex flex-wrap -mx-3 mb-2">
				<div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
			...
			<div className="mt-6 flex items-center justify-end gap-x-6">
				<button
					...
					{loading ? 'Please wait...' :
						<div className={'flex justify-center items-center gap-2'}>Створити <BiSolidSend/></div>}
				</button>
			</div>
		</form>
	)
